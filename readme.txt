...
* [Page Specific Menu Items](http://www.wordpress.org/plugins/page-specific-menu-items/) - Allows you to selectively hide the menu items. One menu different menu items on different page(posts).
